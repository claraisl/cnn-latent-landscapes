"""This script computes and saves the latent landscapes for agricultural 
dataset (CRBD) from the activations maps of the U-Net layers studied. In 
addition, it plots the (average) latent landscapes of every layer, performs PCA 
